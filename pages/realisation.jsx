...
const Realisation = () => {
  ...
  return (
    <>
      <Header />
      <div class="bg-white">
        <div class="max-w-screen-xl mx-auto pb-12 px-4 sm:p-8 sm:px-6 lg:px-8">
          <div class="max-w-4xl mx-auto text-center">
            ...
            <p class="mt-3 text-xl leading-7 text-gray-500 sm:mt-4">
              Nous avons réalisés à ce jour un peu plus de 30 Applications Web,
              mobile (Android & iOs) et Desktop pour plusieurs clients.
            </p>
          </div>
